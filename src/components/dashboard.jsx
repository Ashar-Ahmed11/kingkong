        ...
        <div>
            ...
            <div className="container-fluid">
                <div className="row flex-nowrap">
                    ...
                    <div style={{ position: "sticky", height: "100vh", top: 0 }} className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark d-none d-md-block">
                 ...
                 <div className="col py-3">
                        ...
                        <Switch>
                            <Route exact path="/dashboard/basicsettings">
                            {/* <Home/> */}
                            <BasicSettings/>
                            </Route>
                        </Switch>
                        <Switch>
                            <Route exact path="/dashboard/homepage">
                                <HomePage/>
                            </Route>
                        </Switch>
                        <Switch>
