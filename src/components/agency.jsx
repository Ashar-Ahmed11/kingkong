...
const Agency = () => {
    ...
    return (
        <div style={{ backgroundColor: bgColor }} className=' pb-4 agency-dark'>
            ...
            <h1 className="text-center proHeading display-4 py-4" style={{ fontFamily: "Spooktackler" }}>THUMBNAILS</h1>
            <Projects direction={'left'} />
            ...
            <div className="d-flex justify-content-center">
                <button className="btn btn-outline-primary rounded-4 fw-bold">Contact Us</button>
            </div>
        </div>
    )
}
